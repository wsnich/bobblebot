...
function M.Load(path)
    ...
    -- Rename the EQ window (taskbar) to this character's name while the bot runs. Off by default; opt in via
    -- the Status tab checkbox or /cz wintitle on.
    if M.config.settings.winTitle == nil then M.config.settings.winTitle = false end
