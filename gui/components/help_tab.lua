...
local GROUPS = {
    ...
    { title = "Camp & movement", cmds = {
        ...
        { "/cz togglecampacleash", "Toggle 'leash to radius' (return to camp instead of chasing beyond Radius)." },
        { "/cz chasefleeing on|off", "With leash on, still chase a fleeing/low-HP mob past Radius to finish it." },
    ...
    { title = "Diagnostics", cmds = {
        ...
        { "/cz upgradedebug on|off", "Log spell-upgrade scan results (best same-type book spell per configured spell)." },
    ...
    { title = "Utility", cmds = {
        ...
        { "/cz spellinfo <name>", "Show a spell's upgrade match-keys (TargetType/Subcategory/NumEffects/Level)." },
